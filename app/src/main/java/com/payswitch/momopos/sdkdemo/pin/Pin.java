package com.payswitch.momopos.sdkdemo.pin;
...
public class Pin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (device.endsWith("700")||device.endsWith("900") ){
            //隐藏虚拟键盘
            btnb0.setVisibility(View.INVISIBLE);
            ...
            btnb5.setVisibility(View.INVISIBLE);
            btnb6.setVisibility(View.INVISIBLE);
            btnb7.setVisibility(View.INVISIBLE);
            btnb8.setVisibility(View.INVISIBLE);
            btnb9.setVisibility(View.INVISIBLE);
    ...
    private ICallbackListener callback = new ICallbackListener.Stub() {
        ...
        public int emvCoreCallback(int command, byte[] data, byte[] result, int[] resultlen) throws RemoteException {
            ...
            if(data[0] == 0x11){
                ...
                btnclean.setVisibility(View.INVISIBLE);
                resultlen[0] = 105;
            } else if (data[0] == mCore.PIN_CMD_PREPARE) {
